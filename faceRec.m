...
fprintf(['Here what one original face from the yalefaces database looks like.     ']);
im = imread("subject01.normal.gif");
imagesc(double(im));
fprintf('Program paused. Press enter to continue.\n');
pause;

fprintf(['Each face gets cropped.     ']);
displayData(pixels(:,2)');
...
[classes,accuracy,mins,cMins,iMins]=classifyM(U_norm,mu',allW,subjects,types);
accuracy
...
%============= Part 7: learning =========
 ...
 bar(acc(types));
xlabel("cent, noglas  , sleep, glas, norm, surp   , hap    , rightl    , wink   , leftl    , sad  ");                                      
